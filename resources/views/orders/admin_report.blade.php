...
<div class="container mx-auto px-6 py-12 max-w-4xl">
    <h2 class="text-3xl font-bold text-[#FF914D] mb-8 text-center">Laporan Penjualan
            ...
            <table class="min-w-full bg-white rounded-xl shadow border border-[#FFD6A5]">
                <thead>
                    <tr class="bg-[#FFF6E9] text-[#FF914D]">
                        ...
                        <th class="py-2 px-4">Total Pesanan</th>
                        <th class="py-2 px-4">Total Penjualan</th>
                    </tr>
                </thead>
                <tbody>
                    @foreach($reports as $row)
                        <tr>
                            ...
                            <td class="py-2 px-4">{{ $row->total_orders }}</td>
                            <td class="py-2 px-4">Rp{{ number_format($row->total_sales,0,',','.') }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
